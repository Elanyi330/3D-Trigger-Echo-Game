...
@export var melee_primary_damage: float = 0.0  # 正面首击
@export var melee_secondary_damage: float = 0.0  # 正面连击
@export var melee_stab_damage: float = 0.0  # 重刺
...
@export var melee_range: float = 0.0  # 攻击距离（M1 近似，可调）
