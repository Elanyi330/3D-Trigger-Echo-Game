...
### 任务 7 [haiku] 外环 + 角场
- 数据（设计 §3.8）：外环视线打断 bigtree×4：(-26.5,1.25,12)/(-26.5,1.25,-12)/(26.5,1.25,-12)/(26.5,1.25,12)（bigtree 格式）；角场×4（以 NW 为例，**2026-08-11 碰撞审计修正**：台阶原 z=23.25 侵摊阁 0.25 → 贴缘 23.5；箱簇原缝 0.15 窄缝 → 贴缘）：摊阁 (-26,0.6,21.5) (2.5,1.2,2.5) + 台阶 (-26,0.3,23.5) (1.5,0.6,1.5)【贴摊阁缘 z=22.75】；箱簇 0.9×2：Box1 (-24,0.45,19.65) (1.2,0.9,1.2)【贴摊阁缘 z=20.25】、Box2 (-27.85,0.45,23) (1.2,0.9,1.2)【贴摊阁缘 x=-27.25】；大树 (-23,1.25,22)（bigtree）。四角：NW/NE 用基准偏移，SE/SW = 180° 旋转（生成器 `_corner_court(cx, cz, rot)`；旋转对 NW↔SE、NE↔SW）
