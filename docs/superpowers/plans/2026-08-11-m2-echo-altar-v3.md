...
- 数据（设计 §3.4）：
  ...
  - 摊位簇×2/街（**T3 裁决：可跳箱与 2.2 板同坐落面间距 ≥1.5m**）：东街簇 N = 板 (18.5,1.1,7) (3,2.2,0.4) + 箱 (17,0.45,4.5) (1,0.9,1) + 箱 (20,0.45,4.5) (1,0.9,1)【板 z∈[6.8,7.2] 与箱 z∈[4,5] 缝 1.8 ✓】；簇 S = 板 (18.5,1.1,-7) + 箱 (17,0.45,-4.5) + 箱 (20,0.45,-4.5)；西街 = 180° 旋转
