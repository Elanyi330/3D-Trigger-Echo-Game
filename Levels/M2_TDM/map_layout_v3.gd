...
static var STREETS: Array = [
	...
	# 贴 RimE_T 面 x=14.5）；缺口门墙 = 贴长墙内侧正对外环豁口 z∈[5.5,8]。
	...
	{"name": "EastGapWallS", "kind": "wall", "center": Vector3(22.0, 1.5, -6.75), "size": Vector3(1.0, 3.0, 2.5)},
	...
	{"name": "WestGapWallN", "kind": "wall", "center": Vector3(-22.0, 1.5, 6.75), "size": Vector3(1.0, 3.0, 2.5)},
] \
